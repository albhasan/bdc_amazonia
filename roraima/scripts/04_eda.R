...
samples_tb <- "./roraima/data/samples/samples.rds" %>%
    readRDS() %>%
...
plot_tb %>%
    ...
    ggplot2::ggsave("./roraima/data/samples/plot_samples_bands_flat.png")
plot_tb %>%
    dplyr::filter(Band %in% c("B08", "B8A", "B11", "B12")) %>%
    f_plot() +
    ggplot2::ggtitle("S2 samples - Bands") +
    ggplot2::ggsave("./roraima/data/samples/plot_samples_bands.png")
plot_tb %>%
    dplyr::filter(Band %in% c("EVI", "NDVI", "NDMI")) %>%
    f_plot() +
    ggplot2::ggtitle("S2 samples - Vegetation Indexes") +
    ggplot2::ggsave("./roraima/data/samples/plot_samples_indices.png")
...
plot_pca %>%
    ...
    ggplot2::ylim(0, 1) +
    ggplot2::ggsave("./roraima/data/samples/plot_samples_pca_bands.png")
...
plot_pca %>%
    ...
    ggplot2::ylab("Explained SD") +
    ggplot2::ylim(0, 1) +
    ggplot2::ggsave("./roraima/data/samples/plot_samples_pca_indices.png")
